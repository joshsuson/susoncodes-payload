  ...
  return (
    ...
    >
      ...
      {project.externalUrl ? (
        <p className="mt-2.5">
          <Link
            className="relative z-10 text-[11px] text-shell-accent hover:underline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-shell-accent"
            data-external-link
